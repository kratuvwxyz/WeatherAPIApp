        ...
        <div class="row p-0">
          <div class="col-4 col-sm-2 col-md-12 text-center d-flex align-self-center justify-content-center">
            <div class="row p-0">
              ...
              <div class="col"><img src="http://openweathermap.org/img/wn/${y.weather[0].icon}@2x.png" class="four-image" alt="Weather Icon" width="100%" /></div>
            </div>
          </div>
          <div class="col-8 col-sm-4 col-md-12 p-1 text-center d-flex align-self-center justify-content-center">
            <div class="row p-0">
              <div class="col py-3">
                <span class="four-fs-10">${Math.round((y.main.temp - 273.15) * 1.8 + 32)}<sup class="fs-11">˚F</sup></span>
          ...
          <div class="col-6 d-none d-sm-block col-md-12 text-center under-375" style="letter-spacing: 0">
            <div class="row">
              <div class="col py-3">
                <sup><i class="fas text-secondary fa-temperature-low fs-12"></i></sup>&#160;<span class="fs-11">${Math.round((y.main.temp_min - 273.15) * 1.8 + 32)}</span><sup class="text-primary x fs-12">˚F</sup>&#160;&#160;&#160;<sup><i class="fas text-secondary fa-temperature-high fs-12"></i></sup>&#160;<span class="fs-11">${Math.round((y.main.temp_max - 273.15) * 1.8 + 32)}</span><sup class="text-primary x fs-12">˚F</sup>
              </div>
            </div>
            <div class="row">
              <div class="col py-3">
                <sup><i class="far text-secondary fa-sun fs-12"></i></sup>&#160;<span class="fs-11">${y.main.temp_kf}</span><sup class="text-primary x fs-12">UV</sup>&#160;&#160;&#160;<sup><i class="fas text-secondary fa-tint fs-12"></i></sup>&#160;<span class="fs-11">${y.main.humidity}</span><sup class="text-primary x fs-12">%</sup>
              </div>
            </div>
          </div>
        </div>
